...
function initMessageBox(bNeebBack) {
    ...
    if (bNeebBack) {
        objString += "<input id='DW_btnRemoveAllImages' onclick='btnRemoveAllImages_onclick()' type='button' value='Remove All Images'/><br /><br />";
         //objString += "<span class='btnbacklist' style=\"font-size:larger\"><a href =\"scan\"><b>Back</b></a></span><br /></div>";
       // objString += "<input id='btnbacklist' type='button' onclick='btnback_onclick()' value='Back' /><br /></div>";
    }
    else {
